...
public class PostgresDAO {
    ...
    public void registerUser(String email, String name, String password) throws SQLException{
        String query = "INSERT INTO users( prefer_name, email, password, rides, isdriver, availableCoupons, redeemedCoupons) " +
