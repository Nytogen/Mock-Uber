...
public class TripEndpoint extends Endpoint{
    //Tutorial 1 Code to send API Requests neatly and not spagetti tripinfomicroservice
    public HttpResponse<String> sendRequest(String endpoint, String method, String reqBody) throws IOException, InterruptedException {
        ...
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create("http://tripinfomicroservice:8000" + endpoint))
